...
auto DeclareVariables(T &df) {
    ...
    return df.Define("pt_l"      , "GenPart_pt[ele_idx]")
             .Define("eta_l"     , "GenPart_eta[ele_idx]")
             .Define("phi_l"     , "GenPart_phi[ele_idx]")
             .Define("mass_l"    , "GenPart_mass[ele_idx]")
             .Define("pdgId_l"   , "GenPart_pdgId[ele_idx]")
